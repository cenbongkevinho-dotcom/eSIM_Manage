...
const ArrowUp = "ep:arrow-up-bold";
const EpArrowDown = "ep:arrow-down-bold";
const ArrowLeft = "ep:arrow-left-bold";
const ArrowRight = "ep:arrow-right-bold";
...
/**
 * 获取 i18n t 函数，用于侧边菜单标题、子菜单标题的国际化显示。
 */
const { t } = useI18n();
...
<template>
  ...
  >
    ...
    >
      ...
      >
        {{ t(onlyOneChild.meta.title as string) }}
      </el-text>
